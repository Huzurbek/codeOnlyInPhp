    ...
    <body class="mod-bg-1 mod-nav-link">
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <div class="row" id="js-contacts">
                ...
                <div class="col-xl-4">
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo strtolower($person['username']);?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <div class="info-card-text flex-1">
                                    <a href="page_profile.php?id=<?php echo $person['id'];?>" style="color: #0088cc;">
                                        <?php echo $person['username'];?>
                                    </a>
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">

                                        <?php if($admin||is_auth($user['id'],$person['id'])):?>
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="delete.php?id=<?php echo $person['id'];?>" class="dropdown-item" onclick="return confirm('are you sure?');">
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                ...
                                <div class="d-flex flex-row">
                                    <a href="https://vk.com/<?php echo $person['vk_link'];?>" target="_blank" class="mr-2 fs-xxl" style="color:#4680C2">
                                        <i class="fab fa-vk"></i>
                                    </a>
                                    <a href="https://t.me/<?php echo $person['telegram'];?>" target="_blank" class="mr-2 fs-xxl" style="color:#38A1F3">
                                        <i class="fab fa-telegram"></i>
                                    </a>
                                    <a href="https://www.instagram.com/<?php echo $person['instagram'];?>" target="_blank" class="mr-2 fs-xxl" style="color:#E1306C">
